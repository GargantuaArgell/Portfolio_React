      ...
      <main className="relative z-3 container mx-auto px-6 py-8">
        <div className="flex flex-col lg:flex-row items-center justify-between max-w-6xl mx-auto gap-12">
          ...
          <section className="flex-1 space-y-6">
            ...
            , élève-ingénieur à IMT Atlantique, je suis actuellement en recherche d'une alternance. Mon parcours académique et professionnel s'articule autour du développement back-end et de l'expertise en cybersécurité.
            </p>
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed max-w-2xl">Mon intérêt pour des secteurs aux enjeux complexes (économie, aérospatial, IA, Blockchain) structure mon esprit d'analyse. Cette rigueur me permet d'appréhender rapidement des environnements variés afin d'être plus vite opérationnel.</p>
